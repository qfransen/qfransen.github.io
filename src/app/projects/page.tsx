        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <section className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {createProject('Animation Editor', 'animation.png', undefined, undefined)}
...
function createProject(name: string, image?: string, description?: string, techStack?: string[]): JSX.Element {
    ...
    return (
        <div id={sectionId} className="project flex flex-col bg-card text-card-foreground rounded-lg border shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-200">
            {image && (
                <div className="relative w-full h-48 bg-muted">
                    <Image src={imgPath} alt={alt_description} fill className="object-cover" />
                </div>
            )}
            <div className="p-6 flex flex-col flex-grow">
                <h3 className="text-xl font-semibold tracking-tight mb-2 m-0 p-0">{name}</h3>
                {description && (
