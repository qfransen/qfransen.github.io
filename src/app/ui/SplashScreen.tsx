...
export default function SplashScreen() {
  ...
  useEffect(() => {
    ...
    events.forEach((event) =>
      window.addEventListener(event, handleTrigger, { passive: false }),
    );
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          backgroundColor: !isTypingComplete
            ? "var(--background)"
            : "transparent",
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-background text-foreground">
          <div className="font-mono text-2xl md:text-4xl flex items-center">
            {displayedText}
            <span className="animate-[pulse_1s_step-end_infinite] ml-1 opacity-100">
              _
            </span>
          </div>
        </div>
